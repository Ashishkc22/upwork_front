...
export function DrawCode39Barcode(data, checkDigit) {
...
export function DrawBarcode_Code39(
  data,
  checkDigit,
  humanReadable,
  units,
  ...
  if (backColor == undefined) backColor = "white";

  if (textLocation == undefined) textLocation = "bottom";
  else if (textLocation != "bottom" && textLocation != "top")
    textLocation = "bottom";
  if (textAlignment == undefined) textAlignment = "center";
  else if (
  ...
  if (barWidthRatio == undefined) barWidthRatio = 3;
  if (height == undefined) height = 1;
  else if (height <= 0 || height > 15) height = 1;
  if (width == undefined) width = 3;
  else if (width <= 0 || width > 15) width = 3;
  if (minBarWidth == undefined) minBarWidth = 0;
  else if (minBarWidth < 0 || minBarWidth > 2) minBarWidth = 0;
  if (units == undefined) units = "in";
  else if (units != "in" && units != "cm") units = "in";
  if (humanReadable == undefined) humanReadable = "yes";
  ...
  } else barWidth = (width / totalLength).toFixed(2);
  ...
  if (mode == "html") {
    if (textAlignment == "center") result = '<div style="text-align:center">';
    else if (textAlignment == "left") result = '<div style="text-align:left;">';
  ...
  for (x = 0; x < encodedData.length; x++) {
    var brush;
    if (swing == 0) brush = backColor;
    else brush = foreColor;
  ...
  if (mode == "html") {
    ...
    if (humanReadable == "yes" && textLocation == "bottom") {
      if (textStyle == "")
        humanSpan =
          '<br /><span style="font-family : arial; font-size:12pt">' +
          humanReadableText +
          "</span>";
      else
        humanSpan =
