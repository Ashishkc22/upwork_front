...
const EditCardDialog = ({ open, onClose, data, mode = "Edit" }) => {
  ...
  useEffect(() => {
    if (!isEmpty(data) && mode === "Edit") {
      const d = { ...data, signatureImageUrl: data.signatureImage };
      delete d.signatureImage;
      setFormData(d);
    }
  }, [data]);
                ...
                <FormGroup>
                  {facilities.map((facility) => (
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          checked={formData.basic_facilities?.includes(
                            facility
                          )}
                ...
                <FormGroup>
                  {advanceFacilities.map((facility) => (
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          checked={formData.advance_facilities.includes(
                            facility
                          )}
                          onChange={handleChange}
                    ...
                    <DemoItem label="Date of agreement">
                      <MobileDatePicker
                        {...(formData?.date_of_agreement && {
                          defaultValue:
                            typeof formData.date_of_agreement === "string"
                              ? dayjs(formData.date_of_agreement, "DD-MM-YYYY")
                              : formData.date_of_agreement,
                        })}
                        {...(formData?.date_of_agreement && {
                          value:
                        ...
                        onChange={(e) => {
                          setFormData((prev) => {
                            return {
                              ...prev,
                              date_of_agreement: e.format("DD-MM-YYYY"),
                            };
                          });
                        }}
                      />
